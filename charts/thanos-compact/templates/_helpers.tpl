...
helm.sh/chart: {{ include "thanos-compact.chart" . }}
{{ include "thanos-compact.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "thanos-compact.fullname" .) .Values.serviceAccount.name }}
{{- else }}
