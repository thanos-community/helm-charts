...
| ruler.autoImportPrometheusRules.rbac.create | bool | `true` | Add a ClusterRole and ClusterRoleBinding that allows thanos ruler to read and watch PrometheusRules. Also requires global.rbac.create to be true. |
