...
![Version: 0.23.1](https://img.shields.io/badge/Version-0.23.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.41.0](https://img.shields.io/badge/AppVersion-v0.41.0-informational?style=flat-square)
...
| extraDeploy | list | `[]` | Extra kubernetes objects to deploy with the release. Each item in the array should be a valid Kubernetes manifest (YAML or JSON) for an object to create. The object will be rendered and deployed alongside the Thanos components. This can be used to deploy additional resources such as ConfigMaps, Secrets, or custom resources that are required by your Thanos deployment. |
